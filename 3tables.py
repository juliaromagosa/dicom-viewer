...
path_dir='assets/Base_de_Datos/'+patient_identification_default
...
def update_output_div(patient):
    pathcontinue='{}'.format(patient)
    global path
    path='assets/Base_de_Datos/'+pathcontinue
    return pathcontinue

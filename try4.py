                            ...
                            dbc.Col(
                                html.Div(
                                    ...
                                    children='Image: {}/{}'.format(
                                        pydicom.dcmread(path_initial_ADC).InstanceNumber,Images_ADC),
                        ...
                        dbc.Row([
                            ...
                            dbc.Col(
                                html.Div(
                                    ...
                                    children='Image: {}/{}'.format(
                                        pydicom.dcmread(path_initial_3DT2).InstanceNumber, Images_3DT2),
                                    style={'textAlign': 'right'})),
...
#FUNCION DECIR NUMERO IMAGEN
"""
@app.callback(
    Output(component_id="tittleimahe
    Input(id del instance number)")
)
"""
